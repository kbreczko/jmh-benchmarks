package com.github.kbreczko.jmhbenchmarks.example.geneticalgorithm;
...
public class SimpleGeneticAlgorithm {
    ...
    public Result runAlgorithm(int populationSize, String solution, int maxGenerations) {
        ...
        final Individual fittest = myPop.getFittest();
        return Result.of(fittest.getFitness() < getMaxFitness(), generationCount, fittest);
    }
